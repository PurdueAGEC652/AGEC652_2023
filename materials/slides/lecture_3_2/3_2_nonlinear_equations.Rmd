...
An alternative is to use the `Symbolics.jl` package. For low-dimensional derivative and Jacobians, it does a good job! (I will upload an example to our course materials)
